...
import styles from './MessagesView.less'
...
class MessagesView extends React.Component {
    ...
    showGallery = (url) => {
        let photos = [], _url, photosActiveIndex = 0
        ...
        photos.find((item, index) => {
            if(item.src === url) {
                photosActiveIndex = index
                return true
            }
        })
        this.setState({gallery: true, photos: photos, photosActiveIndex: photosActiveIndex})
    };
                                ...
                                <div className={styles.red_cc}>
                                    <div className={styles.red_cardAvatarWrap}>
                                        <img
                                            ...
                                            src={require('community/assets/images/hb.png')}
                                            rel="noreferrer"
                                        />
                                    </div>
        ...
        return (
            <div className={styles.chatHistory + ' ' + (this.props.cls || '')}
                ...
                <Viewer
                    ...
                    activeIndex={this.state.photosActiveIndex}
                />
            </div>
        )
    }
