...
@hot(module)
@connect(({community_automaticNewGroupMsg}) => ({
...
export default class Index extends PureComponent {
    ...
    move = (record, preIndex, nextIndex) => {
        ...
        this.props.dispatch({
            type: 'community_automaticNewGroupMsg/edit',
    ...
    handleRemove = (record) => {
        Modal.confirm({
            ...
            onOk: () => {
                this.props.dispatch({
                    type: 'community_automaticNewGroupMsg/delete',
    ...
    changeStatus = (e) => {
        this.setState({
            at_all: e.target.checked,
        })
    }

    renderContentFn = ({renderFullTypeMessage}) => {
        const {at_all, tabsActiveKey} = this.state
        const {showAt} = this.props

        const show = showAt && tabsActiveKey === 1
    ...
    render() {
        ...
        const {
            messages: list,
        } = community_automaticNewGroupMsg.sentMsg
                    ...
                    return (
                        <div className={styles.operator}>
                            <FullTypeMessageModal
                                ...
                                renderContentFn={this.renderContentFn}
                                handleOk={({data, handleCancel}) => {
                                    ...
                                    const formData = {
                                        ...
                                        id: record.id,
                                        at_all: showAt && tabsActiveKey === 1 ? at_all : false,
                                    }
                                    ...
                                    this.officialAccountsCardWarning(tabsActiveKey)
                    ...
                    <div className={styles.option}>
                        <FullTypeMessageModal
                            ...
                            handleOk={({data, handleCancel}) => {
                                ...
                                this.props.dispatch({
                                    type: 'community_automaticNewGroupMsg/add',
                                    payload: formData,
                                })
