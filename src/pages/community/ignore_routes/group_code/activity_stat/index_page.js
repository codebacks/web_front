...
@connect(({community_groupCodeActivityStat, loading}) => ({
    community_groupCodeActivityStat,
    queryLoading: loading.effects['community_groupCodeActivityStat/query'],
}))
...
export default class extends Component {
    constructor(props) {
        super(props)
        this.state = {
            filterValue: 'qrcode_show_count', // qrcode_show_count，total_in_count，total_members_count
    ...
    componentDidMount() {
        ...
        if(query?.group_activity_id) {
            this.setState({
                ...
                this.props.dispatch({
                    type: 'community_groupCodeActivityStat/query',
                    payload: {
    ...
    resetParams = () => {
        this.props.dispatch({
            type: 'community_groupCodeActivityStat/resetParams',
        })
    }

    handleChangeDate = (startValue, endValue) => {
        let params = {...this.props.community_groupCodeActivityStat.params}
        if(startValue) {
        ...
        this.props.dispatch({
            type: 'community_groupCodeActivityStat/setParams',
    ...
    handleSearch = () => {
        let {params} = this.props.community_groupCodeActivityStat
    ...
    handleChangeFilter = (e) => {
        ...
        }else if(val === 'total_members_count') {
    ...
    render() {
        const {params, group_activity} = this.props.community_groupCodeActivityStat
            ...
            <div>
                ...
                <div className={styles.activityStat}>
                    <div className={styles.header}>
                        <div>群活动名称：{group_activity?.title}</div>
                        <div>当前总群数：{group_activity?.chatroom_count}</div>
                    </div>
                    ...
                    <div className={styles.lineWrap}>
                        <div className={styles.filterType}>
                            <RadioGroup value={this.state.filterValue} onChange={this.handleChangeFilter}>
                                ...
                                <RadioButton value="total_members_count">群成员总数</RadioButton>
                            </RadioGroup>
                        </div>
