import { query, add, edit, remove, addKeyword, editKeyword, removeCheck } from 'community/services/autoReply/autoReplyTemplate'
...
export default {
    namespace: 'community_autoReplyTemplate',

    state: getInitState(),

    effects: {
        * query({payload, callback}, {select, call, put}) {
            let params = yield select(({community_autoReplyTemplate}) => community_autoReplyTemplate.params)
