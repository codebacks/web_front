...
import { query, addKeyword, editKeyword, getReplyContents, move, removeKeyword, } from 'community/services/autoReply/templateDetail'
...
export default {
    namespace: 'community_autoReply_templateDetail',
