...
export default class AddKeyword extends React.Component {
    ...
    componentWillUnmount() {
        this.props.dispatch({
            type: 'community_autoReply_templateDetail/setProperty',
        ...
        this.props.form.validateFields({force: true}, (err, values)=> {
            if(!err) {
                ...
                && values.content === record?.content && values.match_type === record?.match_type) { // 未修改内容的情况
                    ...
                    this.props.dispatch({
                        type: `community_autoReply_templateDetail/${type === 'edit' ? 'editKeyword': 'addKeyword'}`,
                        payload: {
    ...
    render() {
        ...
        const { replyObj } = this.props.community_autoReply_templateDetail
