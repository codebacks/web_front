 ...
 * @Last Modified time: 2018-09-12 11:25:17
 */
...
export default class Index extends Component {
    ...
    getPayConfigure = (status, item) => {
        ...
        // 如果已经存在支付设置列表则不再请求接口
        this.props.dispatch({
            type: 'setting_subscription/payConfigure',
            payload: {},
            callback: () => {
                this.setState({payConfigure: this.props.setting_subscription.payConfigureList})
            ...
            >
                ...
                <div className={styles.payConfirm}>
                    <div className={styles.currentSub}>
                        <span className={styles.describe}>当前公众号：</span>
