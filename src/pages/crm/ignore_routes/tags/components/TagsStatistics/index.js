...
import qs from 'qs'
import API from 'crm/common/api/tags'
...
@connect(({crm_tagsStatistics, loading}) => ({
    crm_tagsStatistics,
    listLoading: loading.effects['crm_tagsStatistics/list'],
}))
...
export default class TagsStatistics extends React.Component {
    ...
    resetSearch = () => {
        this.props.dispatch({
            type: 'crm_tagsStatistics/resetParams',
        })
        this.goPage(1)
    }
