...
@connect(({crm_massRecord, loading}) => ({
    crm_massRecord,
    detailLoading: loading.effects['crm_massRecord/details'],
    taskIdLoading: loading.effects['crm_massRecord/exportTask'],
}))
...
export default class Index extends React.PureComponent {
    ...
    componentWillUnmount() {
        this.props.dispatch({
            type: 'crm_massRecord/resetDetailParams',
        })
    }
    ...
    loadResult = () => {
        ...
        this.props.dispatch({
            type: 'crm_massRecord/taskResult',
            payload: {id: id},
        })
    }
    ...
    handleChange = (key, e) => {
        ...
        let params = {...this.props.crm_massRecord.detailParams}

        params[key] = val
        this.props.dispatch({
            type: 'crm_massRecord/setProperty',
            payload: {
                detailParams: params,
            },
        })
    ...
    getExportTaskId = (callback) => {
        this.props.dispatch({
            type: 'crm_massRecord/exportTask',
            payload: {
    ...
    exportExcel = (taskId, callback) => {
        this.props.dispatch({
            type: 'crm_massRecord/exportExcel',
            payload: {
                taskId: taskId
            },
            callback: (res) => {
