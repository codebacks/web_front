...
@connect(({crm_massRecord, loading}) => ({
    crm_massRecord,
    tableLoading: loading.effects['crm_massRecord/list'],
}))
...
export default class extends React.Component {
    ...
    handleChange = (key, e) => {
        ...
        let params = {...this.props.crm_massRecord.params}
        params[key] = val

        this.props.dispatch({
            type: 'crm_massRecord/setParams',
    ...
    resetParams = () => {
        this.props.dispatch({
            type: 'crm_massRecord/resetParams',
        })
    }
    ...
    render() {
        ...
        const {tableLoading, crm_massRecord} = this.props
        const {
            params,
            list,
            total,
