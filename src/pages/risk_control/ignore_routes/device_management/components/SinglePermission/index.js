...
export default class Index extends React.Component {
    ...
    componentDidMount() {
        this.props.dispatch({
            type: 'risk_control_deviceManagement/getSinglePermission',
            payload: {
    ...
    handleOk = (e) => {
        e.preventDefault()
        const { dispatch, risk_control_deviceManagement, id } = this.props
        const { singlePermission } = risk_control_deviceManagement
        ...
        this.props.dispatch({
            type: 'risk_control_deviceManagement/setSinglePermission',
            payload: {
                device_id: id,
                body: {
                    ...body,
    ...
    checkboxChange = (index, e) => {
        const { singlePermission } = this.props.risk_control_deviceManagement, val = e.target.checked ? 1 : 0
    ...
    render() {
        const { getLoading, risk_control_deviceManagement } = this.props
        const { singlePermission } = risk_control_deviceManagement
