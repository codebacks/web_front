...
export default class Index extends React.Component {
    ...
    componentDidMount() {
        this.props.dispatch({
            type: 'risk_control_devicePermission/getPermissionConfig',
            payload: {},
        })
    }
    ...
    handleOk = (e) => {
        ...
        const { permissionConfig } = this.props.risk_control_devicePermission
    ...
    confirmHandleOk = () => {
        const {selectedRowKeys = [], dispatch, risk_control_devicePermission,} = this.props
        const { permissionConfig } = risk_control_devicePermission
        ...
        this.props.dispatch({
            type: 'risk_control_devicePermission/setPermissionConfig',
            payload: {
                body: {
                    ...body,
                }
    ...
    checkboxChange = (index, e) => {
        const { permissionConfig } = this.props.risk_control_devicePermission, val = e.target.checked ? 1 : 0
