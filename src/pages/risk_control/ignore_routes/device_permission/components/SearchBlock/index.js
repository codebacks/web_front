...
export default class Index extends React.Component {
    componentDidMount() {
        this.props.dispatch({
            type: 'risk_control_devicePermission/devicesAttributes',
        })
        this.props.dispatch({
            type: 'risk_control_devicePermission/groupsAll',
        })
    }
    ...
    handleChange = (key, e) => {
        ...
        let params = {...this.props.risk_control_devicePermission.params}
        params[key] = val
