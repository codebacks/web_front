...
@hot(module)
@connect(({base, wx_newFriends, loading}) => ({
    base,
    wx_newFriends,
    getConfigLoading: loading.effects['wx_newFriends/getConfig'],
    setConfigLoading: loading.effects['wx_newFriends/setConfig'],
    createContentLoading: loading.effects['wx_newFriends/createContent'],
    deleteContentLoading: loading.effects['wx_newFriends/deleteContent'],
    updateContentLoading: loading.effects['wx_newFriends/updateContent'],
    moveLoading: loading.effects['wx_newFriends/move'],
}))
export default class Index extends PureComponent {
    ...
    getConfig = () => {
        this.props.dispatch({
            type: 'wx_newFriends/getConfig',
            payload: {},
        })
    }

    changeStatus = (e) => {
        const {list} = this.props.wx_newFriends
        ...
        Modal.confirm({
            ...
            onOk: () => {
                return new Promise((resolve) => {
                    this.props.dispatch({
                        type: 'wx_newFriends/deleteContent',
            ...
            <div className={styles.newFriends}>
                <div>
                    ...
                    <span className={styles.mark}>
                        开启后，会自动推送问候信息给新加入的好友；单个微信号可在【<span className={styles.point}>微信号管理-智能管理</span>】重新配置
                    </span>
                </div>
