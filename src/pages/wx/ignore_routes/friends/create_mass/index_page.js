...
@connect((
    ...
    // base,
    wx_createMass,
    submitLoading: loading.effects['wx_createMass/sentMsgHandleSubmit'],
}))
...
@Form.create({
    mapPropsToFields(props) {
        const antdFrom = _.get(props, 'wx_createMass.antdFrom', {})
    ...
    onFieldsChange(props, field, fields) {
        props.dispatch({
            type: 'wx_createMass/setStateByPath',
            payload: {
                path: 'antdFrom',
                value: fields,
            },
...
export default class Index extends PureComponent {
    ...
    handleSubmit = async (e) => {
        ...
        try {
            ...
            this.props.dispatch({
                type: 'wx_createMass/sentMsgHandleSubmit',
                payload: body,
                callback: () => {
                    message.success('创建成功')
                    router.push('/wx/mass_record')
                },
            })
        }catch (e) {
            console.log(e)
    ...
    checkRangeTimePicker = (rule, value, callback) => {
        const {antdFrom: {executeRangeType}} = this.props.wx_createMass
                        ...
                        }
                        {
                            ...
                            >
                                ...
                                <div style={{
                                    ...
                                    lineHeight: '1.5',
                                }}>服务器可在这个时间段内进行群发，若当前不在这个时间范围将顺延到后一天的可执行时间段进行群发
                                </div>
                            </FormItem>
                        }
                    </FormItem>
