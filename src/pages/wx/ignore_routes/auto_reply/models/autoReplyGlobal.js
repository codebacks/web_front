...
import { query, addKeyword, editKeyword, getReplyContents, move, removeKeyword, setStatus, } from 'wx/services/autoReply/autoReplyGlobal'
...
export default {
    ...
    effects: {
        ...
        * query({payload, callback}, {select, call, put}) {
            let params = yield select(({wx_autoReply_global}) => wx_autoReply_global.params)
