...
export default class Index extends PureComponent {
    ...
    goPage = (page) => {
        if(typeof page === 'undefined') {
            page = this.props.wx_Rules.match_contents.current
        }
        this.props.dispatch({
            type: 'wx_Rules/setStateByPath',
            payload: {
    ...
    handleChangeSize = (current, size) => {
        this.props.dispatch({
            type: 'wx_Rules/assignStateByPath',
            payload: {
                path: `match_contents`,
                value: {
                    current: 1,
