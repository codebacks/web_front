...
import api from 'wx/common/api/autoGreet'
...
export async function getOneConfig(params) {
    return request(`${format(api.getOneConfig.url, {uin: params.uin})}?${qs.stringify(params)}`)
}

export async function setOneConfig(params) {
    return request(format(api.setOneConfig.url, {uin: params.uin}), {
...
export async function createOneContent(params) {
    return request(format(api.createOneContent.url, {uin: params.uin}), {
...
export async function deleteOneContent(params) {
    return request(format(api.deleteOneContent.url, {id: params.id, uin: params.uin}), {
...
export async function updateOneContent(params) {
    return request(format(api.updateOneContent.url, {id: params.id, uin: params.uin}), {
...
export async function oneMove(params) {
    return request(format(api.oneMove.url, {id: params.id, uin: params.uin}), {
