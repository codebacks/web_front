...
import {getTree, getQuestions, getReplyContents} from 'wx/services/addKeywordReply'
    ...
    effects: {
        ...
        * getTree({payload, callback}, {select, call, put}) {
            ...
            if(data) {
                ...
                const expandedKeys = yield select(({wx_addKeywordReply}) => wx_addKeywordReply.expandedKeys)
                ...
                let activeSort = yield select(({wx_addKeywordReply}) => wx_addKeywordReply.activeSort)
        ...
        * getQuestions({payload, callback}, {select, call, put}) {
            const { params, activeSort } = yield select(({wx_addKeywordReply}) => wx_addKeywordReply)
            if(payload.page) {
