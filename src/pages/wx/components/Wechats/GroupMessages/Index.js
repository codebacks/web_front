...
class History extends React.Component {
  ...
  componentDidMount() {
      ...
      const params = {
          ...
          content: content,
          offset: last_page ? (-this.props.wx_group_messages.params.limit) : 0,
          old_content: content,
  ...
  componentWillUnmount() {
      this.props.dispatch({
          type: 'wx_group_messages/resetParams',
          payload: {}
      })
  }
  ...
  handleIntoView = (flag) => {
      setTimeout(() => {
          ...
          if (node.length) {
              ...
              const {list, params} = this.props.wx_group_messages
              let idx = 0
              if (flag === 'search') {
  ...
  handlePage(page) {
      let params = {...this.props.wx_group_messages.params}
      params.message_id = ''
      this.props.dispatch({
          type: 'wx_group_messages/setProperty',
  ...
  handleNextPos = () => {
      ...
      if (params.offset < this.props.wx_group_messages.total) {
          setTimeout(() => {
              this.props.dispatch({
                  type: 'wx_group_messages/query',
                  payload: {params: params},
  ...
  render() {
      ...
      let { params:groupMsgParams } = this.props.wx_group_messages
      let { wx_group_messages:groupMsgs } = this.props
