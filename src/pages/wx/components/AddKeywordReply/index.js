...
@connect(({wx_addKeywordReply, loading}) => ({
    wx_addKeywordReply,
    tableLoading: loading.effects['wx_addKeywordReply/getQuestions'],
    getTreeLoading: loading.effects['wx_addKeywordReply/getTree'],
}))
export default class Index extends Component {
    ...
    componentWillUnmount() {
        this.props.dispatch({type: 'wx_addKeywordReply/resetParams',})
    }

    handleOk = () => {
        const { onOk } = this.props
        const { selectedRows } = this.props.wx_addKeywordReply
    ...
    loadTree = (callback) => {
        this.props.dispatch({
            type: 'wx_addKeywordReply/getTree',
            payload: {},
            callback,
        })
    }
    ...
    goPage = page => {
        const { activeSort, tree } = this.props.wx_addKeywordReply
        if(typeof page === 'undefined') {
            page = this.props.wx_addKeywordReply.current
        }
        ...
        this.props.dispatch({
            type: 'wx_addKeywordReply/getQuestions',
            payload: {page: page || 1},
        })
    }
    ...
    onEllipsisClick = (item, e) => {
        ...
        this.props.dispatch({
            type: 'wx_addKeywordReply/updateTree',
            payload: {},
        })
    }
    ...
    onSelect = (checkedKeys, e) => {
        ...
        if(!selected) {
            ...
            let {expandedKeys} = this.props.wx_addKeywordReply
            ...
            this.props.dispatch({
                type: 'wx_addKeywordReply/setProperty',
                payload: {expandedKeys: newExpandedKeys},
            })

        }else {
            this.props.dispatch({
                type: 'wx_addKeywordReply/setActiveSort',
    ...
    handleChange = (key, e) => {
        ...
        this.props.dispatch({
            type: 'wx_addKeywordReply/setParams',
            payload: {
                [key]: val,
            },
        })
    ...
    handleChangeSize = (current, size) => {
        let params = {...this.props.wx_addKeywordReply.params}
        params.limit = size
        this.props.dispatch({
            type: 'wx_addKeywordReply/setProperty',
    ...
    render() {
                            ...
                            renderBtn={(setTrue) => {
                                return (
                                    <span
                                        ...
                                        onClick={() => {
                                            this.props.dispatch({
                                                type: 'wx_addKeywordReply/getReplyContents',
        ...
        const rowSelection = {
            type: 'radio',
            selectedRowKeys: this.props.wx_addKeywordReply.selectedRowKeys,
