...
import { queryFriendsReports as query} from "data/services/business"

const {DateFormat} = config

export default {
    namespace: 'data_business_friends_report',
    state: {
        dailyParams: {
    ...
    effects: {
        * query({payload, callback}, {select, call, put}) {
            ...
            let {params, dailyParams, monthParams, rankParams} = yield select(((state) => state.data_business_friends_report))
            let type = ''
