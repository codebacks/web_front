...
const huzanQiniuResKey = 'HUZAN_QINIU_RES_KEY'
const QiNiuHost = ['upload.qiniup.com', 'up.qiniup.com']
...
class Index extends React.PureComponent {
    ...
    async computeMd5(data) {
        const buffer = await this.readAsArrayBuffer(data)
    ...
    upload = (qiniuAuthRes, option, QiNiuHost = []) => {
        ...
        this.computeMd5(file).then((hash) => {
            if(isAbort) {
                return
            }
